...
public class MapDemoActivity extends AppCompatActivity implements GoogleMap.OnMapLongClickListener{
    ...
    */
    ...
    public void onMapLongClick(final LatLng point) {
        ...
        showAlertDialogueforPoint(point);
    }

    private void showAlertDialogueforPoint(final LatLng point) {
        ...
        alertDialogueBuilder.setView(messageView);

        final AlertDialog alertDialogue = alertDialogueBuilder.create();

        alertDialogue.setButton(DialogInterface.BUTTON_POSITIVE, "OK",
                new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        BitmapDescriptor defaultMarker =
                                BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_AZURE);
                        String title = ((EditText) alertDialogue.findViewById(R.id.etTitle)).getText().toString();
                        String snippet = ((EditText) alertDialogue.findViewById(R.id.etSnippet)).getText().toString();
        ...
        alertDialogue.setButton(DialogInterface.BUTTON_NEGATIVE, "Cancel",
                new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.cancel();
